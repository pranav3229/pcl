...
- **Python Reference SDK & CLI:** `pcl-sdk` reference implementation with CLI commands (`validate`, `match`, `resolve-binding`, `verify`).
- **Developer Documentation:** `README.md`, `docs/QUICKSTART.md`, `docs/ARCHITECTURE.md`, `docs/CLEAN_ROOM_IMPLEMENTATION.md`, `docs/BUILDING_WITH_PCL.md`.
...
- **No In-Core Protocol Drivers:** Core PCL does not spawn ROS nodes or HTTP servers; dispatch is handled by external adapters.
